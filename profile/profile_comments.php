        ...
        <div class="card gedf-card">
          ...
          <div class="card-body">
            ...
            <?php 
              ...
              <?php
                $sql = "SELECT topic.no, topic.created, topic.user_no, likes, name, comment, comments.description_no AS dn,comments.user_no AS cun,comments.created, comments.no AS cn FROM topic LEFT JOIN comments ON topic.no = description_no LEFT JOIN user ON comments.user_no = user.no";
                $result_a = mysqli_query($conn, $sql)or die();
                while($row_a = mysqli_fetch_array($result_a)){
                  if($row_a['no'] === $_GET['no']){
              ?> 
              <a href="./profile.php?no=<?=$row_a['cun']?>">
